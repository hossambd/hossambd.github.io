...
## Post 4b: Login Feature Series: Designing & Managing Authentication API Endpoints

In the previous post of this Login Feature Series, we focused on a technical discussion on decoupling the api from `authContext`  [API decoupling]({% post_url 2026-01-06-react-login-04-auth-api-code %}).
...
Review the code branch bpost4-API-decoupling



### Whats Next

Our next post in the Login Series [API Code]({% post_url 2026-01-06-react-login-04-auth-api-code %}) discusses break down of api endpoints, structuring the api depending on which architectural need and prepare our system for coding the api. 
